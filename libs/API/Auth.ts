...
export const Users = {
  ...
  getByUserIdCMS: async () => {
    try {
      const response = await APIAPPS.get(`/v01/member/api/auth/cms-userById`);
      return response.data;
    } catch (error) {
      throw error;
    }
...
export const DetailUser = {
  getUserId: async () => {
    try {
      const response = await APIAPPS.get(`/v01/member/api/auth/user/byId`);
      return response.data;
    } catch (error) {
      return error;
    }
  ...
  getToken: async () => {
    try {
      const response = await APIAPPS.get(`/v01/member/api/auth/protected`);
      return response.data;
    } catch (error) {
      return error;
    }
