...
export default function TableReconPerDate({ date }: TableReconPerDateProps) {
  ...
  useEffect(() => {
        ...
        const response = await axios.get(
          `/api/reconsiliasi/bayarind/detail-trx`,
          {
            params: {
              ...
              limit: selectedLimit,
              date: date,
              bank: "BAYARIND_BCA_VIRTUAL_ACCOUNT",
            },
          },
        );
    ...
    fetchData();
  }, [currentPage, selectedLimit, search, params, monthFilter, date]);
