  ...
  return (
    <div className="relative">
      ...
      <Dropdown
        ...
        className="shadow-theme-lg dark:bg-gray-dark absolute -right-[240px] mt-[17px] flex max-h-[480px] min-h-10 w-[350px] flex-col rounded-2xl border border-gray-200 bg-black p-3 sm:w-[361px] lg:right-0 dark:border-gray-800"
      >
